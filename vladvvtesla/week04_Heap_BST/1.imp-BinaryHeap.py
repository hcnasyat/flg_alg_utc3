...
Minimun oriented priority queue
...
3) последний слой всегда заполняетсч слева направо без пробелов.
...
def test_heap():
    ...
    print(heap.delMax(), ': should be 7')
    print()

    heap.insert(2)
    heap.insert(9)
    print(heap.delMax(), ': should be 9')
    print(heap.delMax(), ': should be 5')
    print(heap.delMax(), ': should be 3')
    print(heap.isEmpty(), ': should be False')
    print(heap.delMax(), ': should be 2')
    print(heap.isEmpty(), ': should be True')
